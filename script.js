...
top_nav.classList.add("bg-primary")
...
main_container.classList.add("mt-2")
...
col.classList.add("col-lg-6", "col-12","card","pt-4","bg-light")
...
// var inputLabel = document.getElementById('type-area');
